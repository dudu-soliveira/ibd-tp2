...
--- Adicionar os caminhos dos arquivos csv.
\copy vacina_pretrat(cod_ibge, municipio, total_de_doses_aplicadas, primeira_dose, segunda_dose, terceira_dose, dose_reforco, primeira_dose_reforco, segunda_dose_reforco, terceira_dose_reforco, dose_adicional, dose_unica, data) FROM '' DELIMITER ',' CSV HEADER;
